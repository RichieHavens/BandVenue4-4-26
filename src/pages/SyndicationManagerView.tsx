  ...
  return (
    <div className="space-y-8">
      ...
      <div className="bg-neutral-900 border border-neutral-800 rounded-3xl p-12 text-center">
        ...
        <p className="text-neutral-500 max-w-md mx-auto mb-8">Configure how and where your event data is displayed on external partner sites.</p>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-left">
          <div className="p-6 bg-neutral-800 rounded-2xl">
            <h4 className="font-bold mb-2">Feed URL</h4>
            <code className="text-xs text-red-600 bg-black/50 p-2 rounded block">https://api.bandvenue.com/v1/feed/your-id</code>
          </div>
          <div className="p-6 bg-neutral-800 rounded-2xl">
